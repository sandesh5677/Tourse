...
<html>
    ...
    <body style="background-image: url(Image/main.jpg)" >
        <form name="uregister" action="u_register" method="post">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <textarea class="form-control" name="address"style="border:1px solid #3399ff;" onkeypress="javascript:return isAlphanumric(event)"> </textarea>
                </div>
                  <div class="col-sm-1"></div>
            </div>
                    <br>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <label>Gender</label>
                     ...
                     <select class="form-control"style="border:1px solid #3399ff;" name="gender">
